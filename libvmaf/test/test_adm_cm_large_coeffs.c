 ...
 * of the contrast masking threshold no longer fits int16_t. The accumulated
 * threshold can also exceed INT32_MAX after it is rescaled for subtraction;
 * that must clamp the residual to zero instead of overflowing the shift. */
